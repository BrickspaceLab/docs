...
If the login icon is not visible in the mobile header (for example on Shimmer), this is intentional. On smaller screens, adding too many header icons can cause wrapping and layout issues.
