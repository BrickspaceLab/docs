...
* Display a linked article with customizable content blocks inside collection or blog layouts
* Configure the content blocks to highlight key article information
* Adjust spacing and color settings to match your theme design
* Use scroll animations to add engaging motion effects
