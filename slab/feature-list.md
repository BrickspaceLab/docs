...
| Feature                 | Description                                                                                                    |
| ----------------------- | -------------------------------------------------------------------------------------------------------------- |
| Minimum order value     | Set a minimum cart value to unlock the checkout.                                                               |
| Unified cart view       | Display all cart variants grouped under each product.                                                          |
| Cart upsells            | Display a collection of products to upsell.                                                                    |
| Cart editing            | Let customers quickly change variant options for items in their cart. E.g. swap one size for another.          |
| Checkbox upsells        | A simple checkbox that can be used to upsell one-click upgrades such as shipping insurance or gift wrapping.   |
| Cart notes              | Let customers easily add a note to their order.                                                                |
| Progress bar            | Showcase free shipping discount when customers spend a certain amount.                                         |
| Content blocks          | Display custom content to highlight promotions or offers in your cart.                                         |
| Share cart              | Let customers easily share their cart by copying and sharing a URL.                                            |
| Device specific control | Set specific cart types for mobile and desktop. E.g. show a cart alert on mobile and a cart drawer on desktop. |
| Cart drawer             | Display the cart in a slideout overlay drawer.                                                                 |
| Cart alert              | Display the cart in a smaller alert overlay.                                                                   |
| Cart sidebar            | Display the cart in a sticky sidebar.                                                                          |
...
| Easy sharing      | Display a URL that can be easily copied to share a blog post.          |
