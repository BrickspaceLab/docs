...
2. Set **Quick buy template** for quick add.
3. Set **Quick edit template** for quick edit.
4. Enter the product template suffix you want each overlay to use.
5. Leave the field blank to use the default product template.
