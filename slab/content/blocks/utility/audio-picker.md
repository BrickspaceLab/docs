...
* Ensure translations are set up for 'actions.enable\_audio' and 'actions.disable\_audio'
...
| Setting      | Description                      | Options                                                                                                                                                   |
| ------------ | -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Button color | Controls the button color scheme | <p>• Primary<br>• Secondary<br>• Tertiary<br>• Neutral<br>• Plain<br>• Outline<br>• Inverted outline<br>• Blur<br>• Link (default)<br>• Inverted link</p> |
...
| Setting              | Description                   | Options                                                  |
| -------------------- | ----------------------------- | -------------------------------------------------------- |
| Horizontal alignment | Controls horizontal alignment | <p>• Left (default)<br>• Center<br>• Full<br>• Right</p> |
