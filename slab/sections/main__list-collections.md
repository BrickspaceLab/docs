...
The main list collections section renders list-collections template content with shared layout, spacing, media, and display controls. It is intended for collection index pages that show multiple collection cards.

#### Common use cases

* Building the default list-collections page layout.
* Styling collection index pages with consistent spacing and color treatments.
* Adding optional background media behind collection list content.
* Applying responsive visibility and alignment settings.

#### Usage tips

* Use default gap and spacing first, then adjust for card density.
* Verify mobile and desktop card legibility when using background media.
* Keep border position and color aligned with nearby page sections.
* Test visibility settings before publishing device-specific changes.
...
* `_layout__list-collections` (limit: 1)
