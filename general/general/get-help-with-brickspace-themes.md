# Get help with Brickspace themes
...
* **Theme support and pre-sales questions:** use the contact options on [Brickspace Lab — contact](https://brickspacelab.com/pages/contact) (same destination linked from [Contact support](contact-support.md)).
...
Response times and scope are summarized in [Contact support](contact-support.md), including what Brickspace covers versus what requires a developer or Shopify.
